...
namespace BuildingBlocks.Resilience.Http
{
    public class StandardHttpClient : IHttpClient
    {
        ...
        public async Task<HttpResponseMessage> PostAsync(string uri, FormUrlEncodedContent content, string authorizationToken = null, string requestId = null, string authorizationMethod = "Bearer")
        {
            //TBD
            return await DoPostPutAsync(HttpMethod.Post, uri, content, authorizationToken, requestId, authorizationMethod);
        }
